    ...
    var defaults = {
      ...
      advanced: {                     // Do not override advanced unless you know what youre doing
          ...
          buttonHTML: `<div class="btn-group pull-right">
                ...
                <button id="bAcep" type="button" class="btn btn-sm btn-default" style="display:none; background-color: transparent; color: black">
                    <span class="fa fa-check-circle" > </span>
                </button>
                <button id="bCanc" type="button" class="btn btn-sm btn-default" style="display:none; background-color: transparent; color: black">
